...
- **Автонаименование встреч**: После создания саммари краткое название встречи добавляется к папке с файлами без дополнительного LLM-запроса.
...
[*] Session directory: output/2026_02_06 14:00:00
------------------------------------------------------------
[>] RECORDING... Press Ctrl+C to stop
...
[+] Session renamed to: output/2026_02_06 14:00:00 Дейлик платформы
```
